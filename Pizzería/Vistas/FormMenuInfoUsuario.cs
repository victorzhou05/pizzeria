...
namespace Pizzería.Vistas
{
    public partial class FormMenuInfoUsuario : Form
    {
        public FormMenuInfoUsuario()
        {
            ...
            this.visibilidadAdmin();
        }

        // Visibilidad del botón únicamente para rol administrador
        private void visibilidadAdmin()
        {
            if(UsuarioCache.rol == "admin")
            {
        ...
        {
            AbrirPanel(new FormAdministrador());
        }
