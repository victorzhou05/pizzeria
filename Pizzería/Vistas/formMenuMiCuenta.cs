...
namespace Pizzería.Vistas
{
    public partial class formMenuMiCuenta : Form
    {
        ...
        {
            if (String.IsNullOrEmpty(tb_nombre.Text) || String.IsNullOrEmpty(tb_apellido1.Text) || String.IsNullOrEmpty(tb_correo.Text) || String.IsNullOrEmpty(tb_telefono.Text) || String.IsNullOrEmpty(tb_contraseña.Text) || String.IsNullOrEmpty(tb_confirmarContraseña.Text) || String.IsNullOrEmpty(tb_contraseñaActual.Text))
            {
                return false;
            }
            else
