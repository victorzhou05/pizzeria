    ...
    public partial class formMenuPedidos : Form
    {
        ...
        private void actualizarPedidosEntregados()
        {
            ...
            try
            {
                ...
                comando.CommandText = "Select PrecioFinal, Fecha, Direccion from Pedido where id_usuario = @ID and Estado != 'En preparación' and Direccion != 'micasa'";
        ...
        private void actualizarPedidosEnPreparacion()
        {
            ...
            try
            {
                conexion.Open();
                comando.Connection = conexion;
                comando.CommandText = "Select PrecioFinal, Direccion, ID_Pedido from Pedido where id_usuario = @ID and Estado = 'En preparación'";
